...
const Sidebar =()=>{
    const {getUsers,users, selectedUser, setSelectedUser, // users
        unseenMessages , setUnseenMessages } = useContext(ChatContext);

    const {logout, onlineUsers} = useContext(AuthContext) // getusers
            ...
            <div className='p-5'>
                <div className='flex justify-between items-center'>
                    ...
                    group-hover:block'>
                        ...
                        text-sm hover:text-blue-500 '>Edit profile</p>
                            <hr className='my-2 border-t border-gray-500' />
                            <p onClick={()=>logout()} className='cursor-pointer text-sm hover:text-blue-500'>Logout</p>
                        </div>
